...
function ForgotPassword() {
 ...
 const { show, setShow,navigate,
    ...
    sendOtp, verifyOtp, resetPassword } = useAuth({
      resetUrl: `${import.meta.env.VITE_API_URL}/admin/reset`,
      verifyUrl: `${import.meta.env.VITE_API_URL}/admin/verify-otp`,
      resetPasswordUrl:`${import.meta.env.VITE_API_URL}/admin/reset-password`,
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-[350px] space-y-5">
        ...
        <h1 className="text-center text-xl font-bold text-red-700">
          Galaxy Mutton Stall Admin Reset Password
        </h1>
        ...
        {!step ? (
          ...
          <button className="w-full bg-red-600 text-white py-2 rounded-lg font-medium hover:bg-red-700 transition " onClick={(e) => { sendOtp(e) }} >
            Send </button>
            <button className="text-center text-black font-medium hover:text-blue-600 underline transition" onClick={() => navigate('/admin/login') } >
            Back </button>
            </>) :
          verified ? (
